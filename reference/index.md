...
- [`mobdb_has_key()`](https://mobdb.jasonadle.com/reference/mobdb_has_key.md)
  : Check if Mobility Database API token is configured
- [`mobdb_set_key()`](https://mobdb.jasonadle.com/reference/mobdb_set_key.md)
  : Set Mobility Database API refresh token
- [`mobdb_browse()`](https://mobdb.jasonadle.com/reference/mobdb_browse.md)
...
- [`feeds()`](https://mobdb.jasonadle.com/reference/feeds.md) : List and
  filter GTFS Schedule, GTFS-RT, and GBFS feeds
- [`feeds_bbox()`](https://mobdb.jasonadle.com/reference/feeds_bbox.md)
...
- [`filter_by_validation()`](https://mobdb.jasonadle.com/reference/filter_by_validation.md)
...
- [`mobdb_extract_datasets()`](https://mobdb.jasonadle.com/reference/mobdb_extract_datasets.md)
  : Extract latest dataset information from search results
- [`mobdb_extract_locations()`](https://mobdb.jasonadle.com/reference/mobdb_extract_locations.md)
  : Extract location information from search results
- [`mobdb_extract_urls()`](https://mobdb.jasonadle.com/reference/mobdb_extract_urls.md)
  : Extract download URLs from feed results
- [`mobdb_get_feed()`](https://mobdb.jasonadle.com/reference/mobdb_get_feed.md)
  : Get details for a specific feed
- [`mobdb_feed_url()`](https://mobdb.jasonadle.com/reference/mobdb_feed_url.md)
  : Get download URL for a feed

## Utilities

- [`mobdb_cache_clear()`](https://mobdb.jasonadle.com/reference/mobdb_cache_clear.md)
  : Clear mobdb cache
- [`mobdb_cache_info()`](https://mobdb.jasonadle.com/reference/mobdb_cache_info.md)
  : Show cache information
- [`mobdb_cache_list()`](https://mobdb.jasonadle.com/reference/mobdb_cache_list.md)
  : List cached files
- [`mobdb_cache_path()`](https://mobdb.jasonadle.com/reference/mobdb_cache_path.md)
