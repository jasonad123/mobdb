...
- [`feeds()`](https://mobdb.jasonadle.com/reference/feeds.md) status
...
- `mobdb_feeds()` is now called
  [`feeds()`](https://mobdb.jasonadle.com/reference/feeds.md). This is a
...
- [`feeds()`](https://mobdb.jasonadle.com/reference/feeds.md) now
